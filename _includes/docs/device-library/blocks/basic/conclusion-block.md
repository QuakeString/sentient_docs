...
You can now easily install **SENTIENT GATEWAY** on the **{{deviceName}}**, connect your device, and begin sending data.

To go further, explore the [**SENTIENT GATEWAY** documentation](/docs/{{page.docsPrefix}}){: target="_blank"}
...
{% else %}
Now you can easily connect your {{deviceName}} and start sending data to **SENTIENT**.

To go further, explore the [**SENTIENT** documentation](/docs/{{page.docsPrefix}}){: target="_blank"} 
