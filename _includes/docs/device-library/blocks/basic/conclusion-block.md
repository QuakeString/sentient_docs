...
You can now easily install **SENTIENT Edge** on the **{{deviceName}}**, connect your device, and begin sending data.

To go further, explore the [**SENTIENT Edge** documentation](/docs/{{page.docsPrefix}}){: target="_blank"}
