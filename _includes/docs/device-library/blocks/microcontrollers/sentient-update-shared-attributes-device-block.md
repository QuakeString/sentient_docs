...
{% assign updateLedBlinkingPeriod = '
    ...
    ===
        image: /images/devices-library/basic/microcontrollers/dashboard/sentient-example-dashboard-blinking-interval-change.png,
...
{% assign updateLedColor = '
    ===
        image: /images/devices-library/basic/microcontrollers/dashboard/sentient-example-dashboard-change-led-color.png,
        title: You can update the color of the led on the board, using the widget on SENTIENT dashboard. 
'
%}
...
{% assign updateTextOnDisplay = '
    ===
        image: /images/devices-library/basic/microcontrollers/dashboard/sentient-example-dashboard-update-oled-screen.png,
