Create a [dashboard](https://sentient.invenia.in/docs/{{page.docsPrefix}}user-guide/dashboards/){:target="_blank"} to visualize telemetry values in widgets.
...
- You can read more about widgets and their creation in [this guide](https://sentient.invenia.in/docs/{{page.docsPrefix}}user-guide/dashboards/#widgets){:target="_blank"}.  
