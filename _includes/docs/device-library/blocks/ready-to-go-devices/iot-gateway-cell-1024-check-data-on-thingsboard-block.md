Create a [dashboard](https://docs.sentient.invenia.in/docs/{{page.docsPrefix}}user-guide/dashboards/){:target="_blank"} to visualize telemetry values in widgets.
...
- You can read more about widgets and their creation in [this guide](https://docs.sentient.invenia.in/docs/{{page.docsPrefix}}user-guide/dashboards/#widgets){:target="_blank"}.  
