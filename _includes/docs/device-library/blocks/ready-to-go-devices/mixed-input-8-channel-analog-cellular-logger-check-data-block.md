...
- Open SENTIENT and then navigate to Device Groups and then <b>All</b>.  
...
- Also you can check attributes, received from device. 
    ...
    Attributes are additional data sent from the MI-8 to SENTIENT that are more or less fixed and do not change such as the modem IMEI, the SIM ID (ICCID), and the MI-8 firmware version. 
