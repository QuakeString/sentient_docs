...
## Integration with SENTIENT Edge
...
## Installing the SENTIENT Gateway on the reComputer R1100
...
{% assign downloadYMLPE = '
    ===
        ...
        title: Go back to the **“SENTIENT Gateways”** dashboard page and click on the newly added **Gateway device** (reComputer R1100).
    ===
...
![image](/images/devices-library/edge/recomputer-r1100/r1100-logo.webp){: style="float: left; max-width: 300px; max-height: 300px; margin: 0px 30px 0px 0px"}Once the **SENTIENT Edge** and **IoT Gateway** are running on the **Computer R1100** and the **ModBus connector** transfers data, you can visualize it on the **Dashboard** on your **Edge instance**:
