...
{% assign deviceVendorLink = "https://www.lansitec.com/products/uwb-badge-tracker/" %}
...
[UWB Badge Tracker]({{deviceVendorLink}}){:target="_blank"} is designed using LoRaWAN and UWB technologies.<br>
