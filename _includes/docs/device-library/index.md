...
<h1 style="font-size: 28px;">Welcome to the SENTIENT Device library!</h1>

The Device library is a collection of guides and code snippets that explain how to connect popular IoT **development boards** to the SENTIENT platform.
...
In case you wish to integrate existing **LoRaWAN, NB IoT, or SigFox** sensors into SENTIENT, see the [How to connect my device?](/docs/{{page.docsPrefix}}getting-started-guides/connectivity/)
