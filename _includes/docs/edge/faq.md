            ...
            <div id="edge-faq-cat-installation" class="edge-faq-category">
                ...
                <div class="edge-faq-question">
                    ...
                    <div class="edge-faq-answer">
                        ...
                        <p>Legacy devices can be connected to the platform via <a href="/docs/iot-gateway/what-is-iot-gateway/" target="_blank">SENTIENT IoT Gateway</a>. More information is available on the <a href="/docs/{{docsPrefix}}reference/protocols/" target="_blank">connectivity</a> page.</p>
                        {% if docsPrefix == 'pe/edge/' %}
