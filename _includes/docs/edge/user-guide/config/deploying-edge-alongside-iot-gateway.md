...
The [SENTIENT Edge](/docs/{{docsPrefix}}getting-started-guides/what-is-edge/){: target="_blank"} can be run alongside the [SENTIENT Gateway](/docs/iot-gateway/what-is-iot-gateway/){: target="_blank"}. 
...
**SENTIENT Gateway** collects data locally, translates it into the [SENTIENT-compatible communication protocols](/docs/{{peDocsPrefix}}edge/api/){: target="_blank"}, and transmits it to the **SENTIENT Edge**.
...
## Step 3. Provisioning the SENTIENT Gateway on Edge

To provision the **SENTIENT Gateway** on **Edge** instance:

{% include images-gallery.html imageCollection="provisionGW" showListImageTitles="true" %}

## Step 4. Installing the SENTIENT Gateway Software on the Gateway Device
...
To install **SENTIENT Gateway**, create a new directory:
...
Create the docker-compose file for your **SENTIENT Gateway** within this directory:
...
To start the **SENTIENT Gateway**, execute the following command in the terminal:
