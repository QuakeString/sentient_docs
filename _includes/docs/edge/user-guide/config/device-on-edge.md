...
To better understand **Devices** as entities in the context of the **SENTIENT platform**, please refer to [this documentation](/docs/{{peDocsPrefix}}user-guide/ui/devices/){:target="_blank"}.
