...
Installing **Edge** behind a [proxy](https://en.wikipedia.org/wiki/Proxy_server){: target="_blank"} means that the **Edge** instance cannot directly access the internet and all communication to **SENTIENT Cloud** or any other external service is routed through a **proxy server**.
