...
## Dashboard Provision to SENTIENT GATEWAY

The dashboards can be created and managed on the **SENTIENT server**, and then [provisioned](/docs/{{docsPrefix}}getting-started/#step-5-provision-dashboard-to-sentient-gateway){: target="_blank"} to the **Edge instance**. This approach enables the simultaneous deployment of changes to all Edge instances.
...
To **create** the Edge Dashboard on your **SENTIENT GATEWAY** instance, do the following:
...
If you have multiple instances of **SENTIENT GATEWAY**, you can delete the Dashboard on one of them *without affecting* it on the other instances. To delete the **Dashboard** from all **SENTIENT GATEWAY** instances *at once*, delete it from your SENTIENT platform.

### Assign/Remove Customers

Before you assign customers to the Dashboard, make sure that you have assigned them to the **SENTIENT GATEWAY** instance first. You can read more about Customers [here](/docs/{{cloudDocsPrefix}}user-guide/ui/customers/){: target="_blank"}.
