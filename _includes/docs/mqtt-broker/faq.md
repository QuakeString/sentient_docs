<style>
.st-rmqtt-faq-wrapper { padding: 20px 15px 80px; max-width: 1200px; margin: 0 auto; }
.st-rmqtt-faq-wrapper h1 { text-align: center; font-size: 36px; font-weight: 500; line-height: 48px; margin-bottom: 48px; color: #212529; }
.st-rmqtt-faq-sections { display: flex; gap: 40px; }
@media (max-width: 1200px) { .st-rmqtt-faq-sections { flex-direction: column; } }
.st-rmqtt-faq-tabs { display: flex; flex-direction: column; align-items: flex-start; padding: 8px; width: fit-content; margin-bottom: 24px; }
...
.st-rmqtt-faq-question { border-bottom: 1.5px solid rgba(62,154,248,0.12); margin-bottom: 7px; }
.st-rmqtt-faq-question-title { 
    font-size: 18px; 
    font-weight: 500; 
    line-height: 30px; 
    color: #212121; 
...
.st-rmqtt-faq-question-title:hover { color: rgba(33, 33, 33, 0.78) }
.st-rmqtt-faq-question-title:after { 
...
.st-rmqtt-faq-question.open .st-rmqtt-faq-question-title:after { transform: rotate(180deg); }
.st-rmqtt-faq-answer { 
    display: none; 
...
function switchTbmqFaqTab(tabId) {
    ...
    var categories = document.querySelectorAll('.st-rmqtt-faq-category');
    ...
    var category = document.getElementById('st-rmqtt-faq-cat-' + tabId);
    if (category) category.classList.add('active');
}
</script>

<h2>ST-RMQTT - {{st-rmqttName}}</h2>
               ...
               {% if docsPrefix == null %}
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        <p>If this is your first experience with ST-RMQTT, we recommend reviewing the <a href="/docs/{{docsPrefix}}mqtt-broker/getting-started-guides/what-is-sentient-mqtt-broker/" target="_blank">What is ST-RMQTT</a> and <a href="/docs/{{docsPrefix}}mqtt-broker/getting-started/" target="_blank">Getting Started Guide</a> to learn more about its architecture, setup, and key capabilities.</p>
                    </div>
                </div>
                {% endif %}
                {% if docsPrefix == "pe/" %}
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        <p>ST-RMQTT is a high-performance MQTT broker developed by SENTIENT. It enables efficient, reliable, and scalable communication between MQTT clients and IoT applications. ST-RMQTT supports <b>MQTT 3.x</b> and <b>MQTT 5.0</b>, ensuring compatibility with a wide range of devices and industry use cases.</p>
                        <p>The broker is available in two editions: <b>Community Edition (CE)</b> and <b>Professional Edition (PE)</b>.</p>
                        <p>The <b>Professional Edition (PE)</b> is the <b>enterprise-grade</b> version of ST-RMQTT, designed for <b>commercial IoT deployments</b> and large-scale production environments. It includes all the capabilities of the Community Edition, plus advanced features such as:</p>
                        <ul>
                ...
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        <p>To start ST-RMQTT with <b>Docker</b>, run the provided Docker Compose file, which launches all required services (Kafka, Redis, PostgreSQL, and the MQTT broker) in a single command.
                            ...
                            Both methods provide a quick way to get ST-RMQTT running in minutes, whether for testing or production.</p>
                    </div>
                </div>
                <div class="st-rmqtt-faq-question">
            ...
            <div id="st-rmqtt-faq-cat-configuration" class="st-rmqtt-faq-category">
                ...
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        <p>These ports can be modified in the ST-RMQTT configuration file or via environment variables before startup. Make sure your firewall or Kubernetes ingress rules allow access to the selected ports.</p>
                    </div>
                </div>
                <div class="st-rmqtt-faq-question">
            ...
            <div id="st-rmqtt-faq-cat-connectivity" class="st-rmqtt-faq-category">
                ...
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        <p>These options can be configured on the client side. ST-RMQTT automatically handles session persistence and message queuing based on the chosen settings, ensuring reliable reconnect behavior.</p>
                    </div>
                </div>
            </div>
            <div id="st-rmqtt-faq-cat-usage" class="st-rmqtt-faq-category">
                ...
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        <ul>
                            <li><b>Replace</b> the default ST-RMQTT logo and favicon with your own corporate visuals.</li>
                            ...
                            <li><b>Configure custom domains</b> — map your own URL (for example, <code>portal.company.com</code>) so users access ST-RMQTT through your branded domain.</li>
                        </ul>
                ...
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        <ul>
                            ...
                            <li><b>JWT authentication</b> – enables token-based authentication and integration with external identity systems via the ST-RMQTT authentication API.</li>
                        </ul>
                ...
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        <ol>
                            ...
                            <li>Configure ST-RMQTT to verify client certificates for mutual authentication using X.509 Certificate Chain credentials.</li>
                        </ol>
            ...
            <div id="st-rmqtt-faq-cat-licensing" class="st-rmqtt-faq-category">
                <div class="st-rmqtt-faq-question">
                    ...
                    <div class="st-rmqtt-faq-answer">
                        ...
                        {% endif %}
                        {% if docsPrefix == "pe/" %}
                        <p>ST-RMQTT PE is a commercially licensed version of ST-RMQTT available under a subscription-based license. It includes additional enterprise-grade features, support services, and maintenance. Use of the PE version requires a valid license agreement with SENTIENT, Inc.</p>
                        {% endif %}
                    </div>
                </div>
                <div class="st-rmqtt-faq-question">
