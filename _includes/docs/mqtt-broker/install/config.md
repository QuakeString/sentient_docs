...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>true</td>
			<td> Set this parameter to 'true' if your ST-RMQTT is operating as a single-node deployment and you enable limitations for client sessions, Application clients, etc. See 'MQTT_SESSIONS_LIMIT', 'MQTT_APPLICATION_CLIENTS_LIMIT', 'MQTT_TOTAL_RATE_LIMITS_ENABLED', 'MQTT_DEVICE_PERSISTED_MSGS_RATE_LIMITS_ENABLED'.
 ...
 Set this parameter to 'false' if your ST-RMQTT is a cluster deployment (with 2 or more nodes in the cluster).
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>ST-RMQTT open-source REST API documentation</td>
