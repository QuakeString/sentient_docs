...
This guide will help you become familiar with ST-RMQTT {{st-rmqttSuffix}} configuration files and parameters. 
We **strongly recommend** configuring ST-RMQTT using environment variables. 
...
If ST-RMQTT is installed in a Docker Compose environment, you can edit the scripts and add environment variables for 
...
If ST-RMQTT is installed in a K8S environment, you can edit the scripts and add environment variables for the 
...
The parameters are grouped by system components. The list contains the name (address in **sentient-mqtt-broker.yml** file), 
