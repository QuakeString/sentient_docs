...
For more information, please refer to the [Administration REST API](https://sentient.invenia.in/docs/{{docsPrefix}}mqtt-broker/rest-api/#swagger-ui) documentation.
