...
**SENTIENT Edge** allows different types of automation events—**Scheduler** and **Rule Chain** events. 
...
* Prior to **Edge 4.0**, **Rule Chain templates** could not be created or modified directly on **SENTIENT Edge**. They had to be configured in **SENTIENT Cloud** and then synchronized with **Edge**.
