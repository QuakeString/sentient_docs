### SENTIENT Professional Edition v3.1.1 (August 28, 2020)

Everything from [TB CE v3.1.1](https://github.com/sentient/sentient/releases/tag/v3.1.1) with the following improvements.
