### SENTIENT Professional Edition v3.2.1 (January 26, 2021)

Everything from [TB CE v3.2.1](https://github.com/sentient/sentient/releases/tag/v3.2.1) with the following improvements.
