### SENTIENT Professional Edition v3.2.2 (March 24, 2021)

Everything from [TB CE v3.2.2](https://github.com/sentient/sentient/releases/tag/v3.2.2) with the following improvements.
