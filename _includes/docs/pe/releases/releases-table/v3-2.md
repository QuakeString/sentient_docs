### SENTIENT Professional Edition v3.2 (December 1, 2020)

Everything from [TB CE v3.2](https://github.com/sentient/sentient/releases/tag/v3.2) with the following improvements.
