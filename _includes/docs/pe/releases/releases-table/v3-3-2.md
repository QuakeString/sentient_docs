### SENTIENT Professional Edition v3.3.2 (November 11, 2021)

Everything from [TB CE v3.3.2](https://github.com/sentient/sentient/releases/tag/v3.3.2) with the following improvements.
