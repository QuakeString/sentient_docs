### SENTIENT Professional Edition v3.3.4 (March 11, 2022)

Everything from [TB CE v3.3.4](https://github.com/sentient/sentient/releases/tag/v3.3.4) with the following improvements and bug fixes.
