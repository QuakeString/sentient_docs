### SENTIENT Professional Edition v3.4.1 (August 18, 2022)

Everything from [TB CE v3.4.1](https://github.com/sentient/sentient/releases/tag/v3.4.1) with the following improvements and bug fixes.
