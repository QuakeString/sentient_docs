### SENTIENT Professional Edition v3.4.2 (December 1, 2022)

Everything from [TB CE v3.4.2](https://github.com/sentient/sentient/releases/tag/v3.4.2) with the following improvements and bug fixes.
...
* Core:
  * [#7415](https://github.com/sentient/sentient/issues/7415) Fixed Entity Group Name filter;
  * [#7225](https://github.com/sentient/sentient/issues/7225) Fixed Scheduler timezone gap;
