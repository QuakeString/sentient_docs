### SENTIENT Professional Edition v3.4.3 (December 21, 2022)

Everything from [TB CE v3.4.3](https://github.com/sentient/sentient/releases/tag/v3.4.3) with the following improvements and bug fixes.
