### SENTIENT Professional Edition v3.4.4 (February 7, 2023)

Everything from [TB CE v3.4.4](https://github.com/sentient/sentient/releases/tag/v3.4.4) with the following bug fixes.
