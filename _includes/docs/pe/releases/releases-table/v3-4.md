### SENTIENT Professional Edition v3.4 (July 19, 2022)

Everything from [TB CE v3.4](https://github.com/sentient/sentient/releases/tag/v3.4) with the following improvements and bug fixes.
