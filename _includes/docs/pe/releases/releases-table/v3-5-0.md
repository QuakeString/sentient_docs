### SENTIENT Professional Edition v3.5.0 (May 9, 2023)

Everything from [TB CE v3.5](https://github.com/sentient/sentient/releases/tag/v3.5) with the following features and bug fixes.
