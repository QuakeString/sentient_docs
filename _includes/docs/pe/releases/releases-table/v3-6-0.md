### SENTIENT Professional Edition v3.6.0 (Sep 21, 2023)

Everything from [TB CE v3.6](https://github.com/sentient/sentient/releases/tag/v3.6) with the following improvements and bug fixes.
