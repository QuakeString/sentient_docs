### SENTIENT Professional Edition v3.6.1 (Nov 13, 2023)

Everything from [TB CE v3.6.1](https://github.com/sentient/sentient/releases/tag/v3.6.1) with the following improvements and bug fixes.
