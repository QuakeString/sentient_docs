### SENTIENT Professional Edition v3.6.2 (Dec 28, 2023)

Everything from [TB CE v3.6.2](https://github.com/sentient/sentient/releases/tag/v3.6.2) with the following improvements and bug fixes.
