### SENTIENT Professional Edition v3.6.3 (Mar 18, 2024)

Everything from [TB CE v3.6.3](https://github.com/sentient/sentient/releases/tag/v3.6.3) with the following improvements and bug fixes.
