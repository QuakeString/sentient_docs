### SENTIENT Professional Edition v3.7.0 (Jun 17, 2024)

Everything from [TB CE v3.7](https://github.com/sentient/sentient/releases/tag/v3.7) with the following improvements and bug fixes.
