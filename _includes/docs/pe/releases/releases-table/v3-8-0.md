### SENTIENT Professional Edition v3.8.0 (Oct 3, 2024)

Everything from [TB CE v3.8](https://github.com/sentient/sentient/releases/tag/v3.8) with the following improvements and bug fixes.
