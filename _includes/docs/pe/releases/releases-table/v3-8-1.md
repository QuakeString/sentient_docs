### SENTIENT Professional Edition v3.8.1 (Oct 15, 2024)

Everything from [TB CE v3.8.1](https://github.com/sentient/sentient/releases/tag/v3.8.1) with the following improvements and bug fixes.
