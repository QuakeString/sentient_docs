### SENTIENT Professional Edition v4.1.0 (Jul 3, 2025)

Everything from [TB CE v4.1](https://github.com/sentient/sentient/releases/tag/v4.1) with the following improvements and bug fixes.
