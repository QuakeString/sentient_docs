...
## Alarms
Alarms are generated using two <a href="https://sentient.invenia.in/docs/{{docsPrefix}}user-guide/device-profiles/#alarm-rules" target="_blank">Alarm rules</a> in the
