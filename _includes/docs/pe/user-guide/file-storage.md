...
SENTIENT has ability to store binary content (files) in the database.
...
SENTIENT provides access to stored files via **Files** Widget which is part of **Files** Widgets Bundle.
