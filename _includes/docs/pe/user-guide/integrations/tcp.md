...
{% if docsPrefix == "pe/" %}
 - The instance of [SENTIENT Professional Edition](https://sentient.invenia.in/docs/user-guide/install/pe/installation-options/){:target="_blank"} installed locally;
{% endif %}
{% if docsPrefix contains "paas/" %}
