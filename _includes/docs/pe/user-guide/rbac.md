...
| Edge                          | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | SENTIENT Edge is an extension of the SENTIENT platform designed for local data processing and device management in a distributed IoT environment. SENTIENT Edge supports offline operation when there is no access to the cloud-based SENTIENT server. Find out more information about Edge [here](/docs/edge/getting-started-guides/what-is-edge/).                                                                                                                                                                                            |
