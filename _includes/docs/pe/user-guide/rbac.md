...
## SENTIENT vs PE security features comparison

### SENTIENT

![image](/images/user-guide/security/rbac/TB_CE.png)

SENTIENT supports a straight-forward security model with three main roles: *System administrator*, *Tenant administrator*, and *Customer user*. 
...
SENTIENT functionality is sufficient for a lot of simple use cases, especially building real-time [end-user dashboards](/docs/{{docsPrefix}}user-guide/dashboards/).

### SENTIENT Professional Edition

![image](/images/user-guide/security/rbac/TB_PE.png)

SENTIENT Professional Edition brings much more flexibility in terms of user, customer, and role management. 
...
SENTIENT supports the "recursive" customer hierarchy with tens of thousands of sub-customers.
...
The SENTIENT Professional Edition security model support advanced RBAC for IoT applications and includes security features such as:
...
This document covers features that are exclusive to SENTIENT Professional Edition. We will start with a glossary and will provide step-by-step examples of how to configure the most popular use cases.
...
Users are able to login to the SENTIENT web interface, execute REST API calls, access devices, and assets if it's allowed. The User is also an Entity in SENTIENT.
...
An Entity can be a device, asset, user, dashboard, entity view, etc. Any entity is managed by SENTIENT. See [entities and relations](/docs/{{docsPrefix}}user-guide/entities-and-relations/) guide for more details.
...
If the Customer owner is another Customer, it means that this is a sub-customer. There might be multiple levels of Customers in SENTIENT.

**Resource**

Anything that has the secure APIs or represents a SENTIENT Entity is a resource. 
...
In SENTIENT Professional Edition, there are two role types: [Generic](/docs/{{docsPrefix}}user-guide/rbac/#generic-role) and [Group](/docs/{{docsPrefix}}user-guide/rbac/#group-role). Each type comes with its own permission model.
...
SENTIENT uses a linking object called a <b>Group Permission Entity (GPE)</b> to assign a Generic role to a <b>user group</b>. The GPE binds who (the user group) to what (the scope) with which rights (the role&#39;s permissions).
...
| API Usage State               | "All", "Read", "Read Telemetry"                                                                                                                                                                                                                                                                    | API Usage layout is in the main menu of the SENTIENT platform. API Usage shows full statistics on the platform. Learn more about API Usage [here](/docs/{{docsPrefix}}user-guide/ui/aliases/#api-usage-state).                                                                                                                                                                                                                                                                                                                                           |
...
| Edge                          | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | SENTIENT GATEWAY is an extension of the SENTIENT platform designed for local data processing and device management in a distributed IoT environment. SENTIENT GATEWAY supports offline operation when there is no access to the cloud-based SENTIENT server. Find out more information about Edge [here](/docs/edge/getting-started-guides/what-is-edge/).                                                                                                                                                                                            |
...
| Integration                   | "All", "Change Owner", "Create", "Delete", "Read", "Read Attributes", "Read Telemetry", "Write", "Write Attributes", "Write Telemetry"                                                                                                                                                             | Integration is the process of connecting and interacting SENTIENT with other systems or devices to exchange and manage data. To know more about the Integrations check the article [here](/docs/{{docsPrefix}}user-guide/integrations/).                                                                                                                                                                                                                                                                                                                 |
...
| Profile                       | “All”, “Read”, “Write”, “Create”, “Delete”                                                                                                                                                                                                                                                         | With these permissions, the user can edit their profile information and change the login password for their SENTIENT instance.                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| Role                          | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Roles in SENTIENT define a set of permissions and access rights assigned to users to perform specific actions in the system. Roles allow limiting or granting access to functionality and data based on the user’s role.                                                                                                                                                                                                                                                                                                                                 |
| Rule Chain                    | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Rule Chain in SENTIENT is a sequence of rules and actions applied to data received from devices or other sources. Rule Chains automate data processing, enable decision-making based on specific conditions, and perform actions such as notifications, device state changes, and other operations. Rule Chains can be configured to process and route data for various purposes, simplifying the development and deployment of IoT logic in the SENTIENT system. Learn more about rule chain [here](/docs/{{docsPrefix}}user-guide/ui/rule-chains/). |
...
| Tenant                        | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | Sentient tenant is an individual user or organization that has a separate space to manage their devices and data within the SENTIENT platform. Learn more about users [here](/docs/{{docsPrefix}}user-guide/ui/tenants/).                                                                                                                                                                                                                                                                                                                             |
| User                          | “All”, “Change Owner”, “Create”, “Delete”, “Read”, “Read Attributes”, “Read Telemetry”, “Write”, “Write Attributes”, “Write Telemetry”                                                                                                                                                             | User is an entity that can log in to the SENTIENT web interface, execute REST API calls, access devices, assets and other entities if they have permissions to do so. Learn more about users [here](/docs/{{docsPrefix}}user-guide/ui/users/).                                                                                                                                                                                                                                                                                                           |
...
| Version Control               | “All”, “Delete”, “Read”, “Write”                                                                                                                                                                                                                                                                   | SENTIENT Version Control service provides the ability to export and restore SENTIENT Entities using Git. Learn more about Version Control [here](/docs/{{docsPrefix}}user-guide/version-control/).                                                                                                                                                                                                                                                                                                                                                    |
...
To summarize those requirements in SENTIENT terms, we should implement the following roles:
...
Let's configure SENTIENT to support this use case. The instructions below assume that you have logged in as a Tenant Administrator.
