...
API & Rate limits are **disabled by default**. System administrator is able to configure rate limits using [sentient.yml](/docs/user-guide/install/{{docsPrefix}}config/).
