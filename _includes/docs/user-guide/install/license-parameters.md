<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Instance data is auto-generated and is used to identify particular SENTIENT Instance.<br>
                ...
                Please make sure that sentient process has access to the instance data file, in case you use absolute path.</td>
        </tr>
    </tbody>
</table>
