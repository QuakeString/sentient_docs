...
- **Email**. A one-time verification code is sent to the user’s email address after entering valid credentials. To use email-based 2FA, a system administrator should configure an [outgoing mail server](/docs/{{docsPrefix}}user-guide/ui/mail-settings/){:target="_blank"}.
