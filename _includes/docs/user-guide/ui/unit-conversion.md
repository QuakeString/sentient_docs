...
Starting from SENTIENT 4.1, widgets support automatic data conversion and unit switching based on the selected unit system. 
...
To change the unit system used in your SENTIENT account:
