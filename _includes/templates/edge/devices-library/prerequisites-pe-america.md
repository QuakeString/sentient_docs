...
* [SENTIENT Cloud (North America)](https://sentient.cloud/signup){: target="_blank"} or the **SENTIENT** [local server](/docs/user-guide/install/installation-options/){: target="_blank"} as an alternative.
