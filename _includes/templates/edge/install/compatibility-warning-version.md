...
Ensure your <b>SENTIENT Server is up to date</b> before updating SENTIENT Edge.
...
The following instructions are applicable for <b>SENTIENT Edge {{previousVersion}}</b> version.
{% endcapture %}
