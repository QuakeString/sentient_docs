...
--name my-tb-pe-http-integration --network edge_docker_default --restart always sentient/tb-pe-http-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- **-v ~/.tb-pe-http-integration-logs:/var/log/tb-http-integration:** Mounts the host's dir **~/.tb-pe-http-integration-logs** to SENTIENT remote integration logs directory.
...
- **sentient/tb-pe-http-integration:{{ site.release.pe_full_ver }}:** The docker image.
