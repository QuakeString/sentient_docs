...
--name my-tb-pe-opc-ua-integration --network edge_docker_default --restart always sentient/tb-pe-opc-ua-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- **-v ~/.tb-pe-opc-ua-integration-logs:/var/log/tb-opc-ua-integration:** Mounts the host's dir **~/.tb-pe-opc-ua-integration-logs** to SENTIENT remote integration logs directory.
...
- **sentient/tb-pe-opc-ua-integration:{{ site.release.pe_full_ver }}:** The docker image.
