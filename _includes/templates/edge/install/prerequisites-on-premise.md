...
You can install the **SENTIENT {{appPrefix}}** local server. For this, please refer to the [SENTIENT installation guide](/docs/user-guide/install/{{peDocsPrefix}}installation-options/){:target="_blank"}. 
