...
To start running **SENTIENT {{appPrefix}} Edge**, you will need an active **SENTIENT {{appPrefix}} account** that supports **Edge** functionality.
...
{% assign addEdge = '
    ===
        ...
        title: Sign in to your **SENTIENT Professional Edition** instance and navigate to the **Edge Management > Instances** section. Click the **"+"** icon in the top right corner and select the **"Add new edge"** option.
    ===
...
* If the **Edge** runs in a [Docker container](https://docs.docker.com/get-started/docker-overview/){:target="_blank"}, **do not** use “localhost” as the endpoint. Instead, use the **IP address** of the machine where **SENTIENT Professional Edition** is hosted and accessible by the Edge container. For example, http://10.7.2.143:8080.
...
{% assign addEdge = '
    ===
        ...
        title: Sign in to your **SENTIENT** instance and navigate to the **Edge Management > Instances** section. Click the **"+"** icon in the top right corner and select the **"Add new edge"** option.
    ===
