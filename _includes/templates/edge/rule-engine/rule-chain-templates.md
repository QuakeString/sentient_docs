...
{% assign createRuleChainTemplatePE = '
    ===
        ...
        title: Sign in to your <b>SENTIENT Professional Edition</b> instance and go to the <b>Edge Management > Rule chain templates</b> section. To add a new **Rule chain**, click the <b>"+"</b> button in the top right corner and choose the <b>"Create new rule chain"</b> option.
    ===
...
{% assign createRuleChainTemplateCE = '
    ===
        ...
        title: Sign in to your <b>SENTIENT</b> instance and go to the <b>Edge Management > Rule chain templates</b> section. To add a new <b>Rule chain</b>, click the <b>"+"</b> button in the top right corner and choose the <b>"Create new rule chain"</b> option.
    ===
