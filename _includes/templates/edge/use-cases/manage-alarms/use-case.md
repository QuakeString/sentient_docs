Let's assume you have a warehouse with two devices connected to SENTIENT **Edge**: 
* DHT22 temperature sensor
* Air Conditioner 

SENTIENT GATEWAY has the following responsibilities:
 ...
 * In case if the temperature becomes critical, SENTIENT GATEWAY turns on the cooler system by **sending RPC call requests** to the Air Conditioner device
