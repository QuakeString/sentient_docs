...
* transparent - Load Balancer that simply forwards traffic to http and https ports of the SENTIENT. Requires you to provision and maintain valid SSL certificate.
...
{% assign staticIP = "sentient-http-lb-address" %}
