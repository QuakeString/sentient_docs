...
```bash
docker pull sentient/tb-pe-aws-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
--name my-tb-pe-aws-integration --restart always sentient/tb-pe-aws-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- `-v ~/.tb-pe-aws-integration-logs:/var/log/tb-aws-integration`   - mounts the host's dir `~/.tb-pe-aws-integration-logs` to SENTIENT logs directory;
...
- `sentient/tb-pe-aws-integration:{{ site.release.pe_full_ver }}`          - docker image.
