...
```bash
docker pull sentient/tb-pe-azure-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
--name my-tb-pe-azure-integration --restart always sentient/tb-pe-azure-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- `-v ~/.tb-pe-azure-integration-logs:/var/log/tb-azure-integration`   - mounts the host's dir `~/.tb-pe-azure-integration-logs` to SENTIENT logs directory;
...
- `sentient/tb-pe-azure-integration:{{ site.release.pe_full_ver }}`          - docker image.
