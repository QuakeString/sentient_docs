...
```bash
docker pull sentient/tb-pe-http-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
--name my-tb-pe-http-integration --restart always sentient/tb-pe-http-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- `-v ~/.tb-pe-http-integration-logs:/var/log/tb-http-integration`   - mounts the host's dir `~/.tb-pe-http-integration-logs` to SENTIENT logs directory;
...
- `sentient/tb-pe-http-integration:{{ site.release.pe_full_ver }}`          - docker image.
