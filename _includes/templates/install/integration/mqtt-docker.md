...
--name my-tb-pe-mqtt-integration --restart always sentient/tb-pe-mqtt-integration:{{ site.release.pe_full_ver }}
```
{: .copy-code}
...
- `-v ~/.tb-pe-mqtt-integration-logs:/var/log/tb-mqtt-integration`   - mounts the host's dir `~/.tb-pe-mqtt-integration-logs` to SENTIENT logs directory;
...
- `sentient/tb-pe-mqtt-integration:{{ site.release.pe_full_ver }}`          - docker image.
