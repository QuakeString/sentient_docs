Configure the Edge load balancer if you plan to connect Edge instances to your SENTIENT server.
...
After the Edge load balancer is provisioned, you can connect Edge instances to your SENTIENT server.
