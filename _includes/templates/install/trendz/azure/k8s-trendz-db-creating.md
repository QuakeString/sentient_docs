Edit “sentient-analytics/sentient-analytics-secret.yml” and replace YOUR_AZURE_POSTGRES_ENDPOINT_URL, YOUR_AZURE_POSTGRES_USER and YOUR_AZURE_POSTGRES_PASSWORD and apply Kubernetes Job:
```text
