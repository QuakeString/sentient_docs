The configuration in this unit provides settings for processing data on Modbus server. These settings will be interpreted in SENTIENT platform instance as attributes/time series of the device.
