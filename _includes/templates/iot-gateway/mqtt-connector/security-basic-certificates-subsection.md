...
| pathToCACert      | **/etc/sentient-gateway/ca.pem**          | Path to CA file.           |
| pathToPrivateKey  | **/etc/sentient-gateway/privateKey.pem**  | Path to private key file.  |
| pathToClientCert  | **/etc/sentient-gateway/certificate.pem** | Path to certificate file.  |
| ---               
