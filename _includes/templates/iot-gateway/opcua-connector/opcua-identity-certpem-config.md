...
| caCert        | **/etc/sentient-gateway/ca.pem**           | Path to the CA certificate.                                               |
| privateKey    | **/etc/sentient-gateway/private_key.pem**  | Path to the private key.                                                  |
| cert          | **/etc/sentient-gateway/cert.pem**         | Path to the certificate file.                                             |
