...
| read_records_count       | **10**                                       | Count of messages to get from storage and send to SENTIENT. |
| max_records_count *      | **100**                                      | Maximum count of data in storage before send to SENTIENT.   |
|---
