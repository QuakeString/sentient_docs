...
#define SENTIENT_ENABLE_PROGMEM 0
...
// See https://sentient.io/docs/pe/getting-started-guides/helloworld/
// to understand how to obtain an access token
constexpr char TOKEN[] = "YOUR_DEVICE_ACCESS_TOKEN";

// SENTIENT we want to establish a connection too
// use the below: if you are using SENTIENT Cloud (America)
constexpr char SENTIENT_SERVER[] = "sentient.cloud";
// use the below: if you are using SENTIENT Cloud (Europe)
// constexpr char SENTIENT_SERVER[] = "eu.sentient.cloud";
...
SENTIENT tb(mqttClient, MAX_MESSAGE_SIZE);
