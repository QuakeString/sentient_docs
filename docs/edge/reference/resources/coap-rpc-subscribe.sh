# Subscribe to RPC requests. Replace $SENTIENT_EDGE_HOST_NAME and $ACCESS_TOKEN with corresponding values.
...
coap-client -m get coap://$SENTIENT_EDGE_HOST_NAME/api/v1/$ACCESS_TOKEN/rpc -s 100 -B 100
