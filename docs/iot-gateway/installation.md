          ...
          <div class="container">
            <div class="install-options-hero-content">
                ...
                <div class="install-options-description">
                    <p>
                        SENTIENT Gateway is designed to run and utilize on majority of hardware, from single-board computers like Raspberry Pi to powerful Edge Gateways for IoT
                    </p>
                </div>
            </div>
