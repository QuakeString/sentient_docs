...
create-client-credentials:
    0:
        image: /images/mqtt-broker/user-guide/integrations/how-to-connect-tbqm-to-sentient/st-rmqtt-add-client-credentials-1-pe.png
        title: 'Navigate to "Credentials" tab, click on the "plus" icon in the top right corner of the table;'
    1:
        image: /images/mqtt-broker/user-guide/integrations/how-to-connect-tbqm-to-sentient/st-rmqtt-add-client-credentials-2-pe.png
        title: 'Input client credentials name, select client type. Enable "Basic" authentication type.'
    2:
        image: /images/mqtt-broker/user-guide/integrations/how-to-connect-tbqm-to-sentient/st-rmqtt-add-client-credentials-3-pe.png
    ...
    3:
        image: /images/mqtt-broker/user-guide/integrations/how-to-connect-tbqm-to-sentient/st-rmqtt-add-client-credentials-4-pe.png
...
successful-connection-st-rmqtt-to-sentient:
    0:
        image: /images/mqtt-broker/user-guide/integrations/how-to-connect-tbqm-to-sentient/st-rmqtt-sessions-1-pe.png
...
st-rmqtt-home-page:
    0:
        image: /images/mqtt-broker/user-guide/integrations/how-to-connect-tbqm-to-sentient/st-rmqtt-home-page-1-pe.png
