...
login-with-domain:
    0:
        ...
        title: 'Now you can use your domain name to access SENTIENT Cloud web interface and services. Try to login by entering the chosen domain name in the browser address line.'
