...
description: Domain managing through EU SENTIENT Cloud
...
login-with-domain:
    0:
        ...
        title: 'Now you can use your domain name to access EU SENTIENT Cloud web interface and services. Try to login by entering the chosen domain name in the browser address line.'
