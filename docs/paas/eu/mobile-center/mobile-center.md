...
captcha:
    ...
    1:
        ...
        title: 'Specify the domain name of your SENTIENT instance. Choose reCAPTCHA type;'
    2:
...
configuration-dialog:
    0:
        ...
        title: 'Next, a configuration dialog will open, which contains the basic configuration settings for the SENTIENT Professional Edition Mobile Application.'
