...
assignees:
- ashvayka
title: SENTIENT EU Cloud Subscription plans definition
description: Features and advantages of subscription payment model
redirect_from:
  - "/products/paas/eu/subscription/"
  - "/docs/paas/eu/subscription/"

cancel-my-subscription:
    0:
        image: /images/subscriptions/cancel-my-subscription-1-paas-eu.png
        title: 'Log in to SENTIENT EU Cloud as a Tenant Administrator. After logging in, go to account settings by clicking the three-dot icon in the upper-right corner of the screen and selecting "Account" from the dropdown menu;'
    1:
