...
google-configuration-of-sentient-google-1:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-1-paas.png
        title: 'Login to your EU SENTIENT Cloud account. Go to the "OAuth 2.0" page of the "Security" section. While on the "Domains" tab, click the "plus" icon;'
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-2-paas.png
...
google-configuration-of-sentient-google-2:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-3-paas.png
    ...
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-4-paas.png
...
google-configuration-of-sentient-google-3:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-5-paas.png
...
google-configuration-of-sentient-google-4:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-6-paas.png
        title: 'The OAuth client is added successfully. Click "Add" again to confirm the addition of the domain;'
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-7-paas.png
...
oauth0-configuration-of-sentient-1:
    ...
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-2-paas.png
        title: 'Enter your domain name of your EU SENTIENT Cloud instance. Click "Create new" in the "OAuth 2.0 clients" section to add a new one.'

oauth0-configuration-of-sentient-2:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-3-paas.png
...
oauth0-configuration-of-sentient-3:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-4-paas.png
...
oauth0-configuration-of-sentient-4:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-5-paas.png
        title: 'The OAuth0 client has been successfully added. Click "Add" again to confirm the addition of the domain.'
    1:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-6-paas.png
        title: 'A new domain has been added.'
...
keycloak-add-sentient-oauth-client-1:
    0:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-1-paas.png
        title: 'Login to your EU SENTIENT Cloud account. Navigate to the "OAuth 2.0 clients" tab, and click "plus" icon to add a new client;'
    1:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-2-paas.png
...
keycloak-add-sentient-oauth-client-2:
    0:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-3-paas.png
    ...
    1:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-4-paas.png
