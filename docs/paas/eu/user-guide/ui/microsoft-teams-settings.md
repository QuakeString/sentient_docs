...
description: SENTIENT IoT platform Microsoft Teams settings
microsoft-teams-settings:
    ...
    2:
        ...
        title: 'Configure how SENTIENT will appear when sending messages to your channel (choose a name and icon), and click "Create";'
    3:
        image: /images/user-guide/ui/microsoft-teams/microsoft-teams-4-settings.png
        title: 'Now, copy the webhook URL. We will use it when adding a notification recipients group in your SENTIENT instance'
