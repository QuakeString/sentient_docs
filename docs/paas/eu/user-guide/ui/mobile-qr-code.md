...
download-app-with-qr-code:
    0:
        image: /images/user-guide/ui/qr-code/qr-code-sentient-home-page-1-paas.png
        title: 'Log into your SENTIENT account and navigate to the "Home" page. You will find the QR code for connecting the mobile app in the bottom right corner;'
    1:
        image: /images/user-guide/ui/qr-code/qr-code-scan-and-install-app-paas.png
        title: 'Open the camera app on your phone or tablet and point it at the QR code. The phone will automatically scan the code and show the link button. Click this button to open the link to download the <b>SENTIENT Cloud mobile app</b>;'
    2:
        image: /images/user-guide/ui/qr-code/qr-code-mobile-install-app-paas.png
        title: 'Install SENTIENT Cloud mobile application;'
    3:
        image: /images/user-guide/ui/qr-code/qr-code-mobile-open-app-1-paas.png
        title: 'Launch the SENTIENT mobile app to start using it.'

clicking-button:
    0:
        image: /images/user-guide/ui/qr-code/qr-code-sentient-home-page-2-paas.png
        title: 'Clicking the "App Store" or "Google Play" button in the "Connect mobile app" widget, you will be redirected to the SENTIENT app page in the respective app store for further downloading to your device.'
    1:
...
authorize-with-qr-code:
    0:
        ...
        title: 'Launch the SENTIENT Cloud mobile app on your device and use the QR code scanning feature. Make sure you have the latest version of the app installed;'
    2:
        image: /images/user-guide/ui/qr-code/qr-code-scan-and-open-app-pe.png
        title: 'Scan the QR code on the "Home" page of your SENTIENT instance using the mobile app. You will find the QR code for connecting the mobile app in the bottom right corner;'
    3:
        image: /images/user-guide/ui/qr-code/qr-code-mobile-dashboard-1-paas.png
        title: 'You have successfully logged into the SENTIENT Cloud mobile app with your account.'
...
application-settings-default:
    0:
        ...
        title: 'Leave "Default" applications settings to use the <b>SENTIENT Cloud</b> mobile application.'
