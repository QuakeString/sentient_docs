...
assignees:
- ashvayka
title: SENTIENT US Cloud Subscription plans definition
...
cancel-my-subscription:
    0:
        ...
        title: 'Log in to SENTIENT Cloud as a Tenant Administrator. After logging in, go to account settings by clicking the three-dot icon in the upper-right corner of the screen and selecting "Account" from the dropdown menu;'
    1:
