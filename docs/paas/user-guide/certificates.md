...
{% capture difference %}
**Pay attention!** [SENTIENT Cloud](https://sentient.cloud/signup) has a separate domain for MQTT traffic. It cannot be white-labeled. If you want an encrypted traffic via MQTT, the device should refer to the corresponding host — **mqtt.sentient.cloud**
{% endcapture %}
