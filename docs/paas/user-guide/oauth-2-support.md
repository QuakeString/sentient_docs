...
google-configuration-of-sentient-google-1:
    0:
        ...
        title: 'Login to your SENTIENT Cloud account. Go to the "OAuth 2.0" page of the "Security" section. While on the "Domains" tab, click the "plus" icon;'
    1:
...
oauth0-configuration-of-sentient-1:
    ...
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-2-paas.png
        title: 'Enter your domain name of your SENTIENT Cloud instance. Click "Create new" in the "OAuth 2.0 clients" section to add a new one.'
...
keycloak-add-sentient-oauth-client-1:
    0:
        ...
        title: 'Login to your SENTIENT Cloud account. Navigate to the "OAuth 2.0 clients" tab, and click "plus" icon to add a new client;'
    1:
