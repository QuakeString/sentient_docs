...
supervisors-add-new-user:
    ...
    3:
        ...
        title: 'Click on the "+" sign at the top right of the screen. Input email address, for instance, we can use janesmith@sentient.invenia.in, and click "Add".'
    4:
...
supervisors-create-read-only-user:
    ...
    1:
        ...
        title: 'Click "+" at the top right of the screen to add new user. Input email address, for example, we will use bob@sentient.invenia.in, then click "Add".'
    2:
