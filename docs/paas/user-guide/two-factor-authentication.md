...
2fa-configuration:
    0:
        ...
        title: 'Log in to SENTIENT as the Tenant administrator.<br>- Navigate to <b>Security</b> &#8702; <b>Two-factor authentication</b> (1).<br>- Uncheck the box labeled "Use system two factor auth settings" (2).'
    1:
