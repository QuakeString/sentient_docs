...
description: Release notes and changelog for SENTIENT GATEWAY v4.2.x
breadcrumbs: 'true'
breadcrumbs-steps: '1'
lts: February 2027
...
{% include docs/pe/edge/edge-releases-table/v4-2-2-1.md %}
{% include docs/pe/edge/edge-releases-table/v4-2-2.md %}
