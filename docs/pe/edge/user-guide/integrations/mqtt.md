...
assign-integration:
    ...
    5:
        ...
        title: 'Login to your <b>SENTIENT Edge</b> instance and go to the <b>Integrations center > Integrations</b> section. You should see your integration. Click on it.'
    6:
...
**MQTT Integration** allows connecting to external MQTT brokers, subscribe to data streams from those brokers, and convert any type of payload from your devices to the SENTIENT Edge message format. 
...
SENTIENT Edge MQTT Integration acts as an MQTT client. 
...
The **MQTT broker** should either be co-located with the **SENTIENT Edge** instance or deployed in the cloud and have a valid DNS name or static IP address.
{% endcapture %}
...
- **MQTT broker** that can be accessed through the **SENTIENT Edge** instance: broker.hivemq.com (port 1883);
...
Now, go to the **Integrations center > Integrations** section and select the **"Events"** tab in your MQTT integration on the **SENTIENT Edge**. 
...
Go to the **Devices** page, select your device, and navigate to the **"Attributes"** tab on the **SENTIENT Edge**.
...
An example of incoming messages from **SENTIENT Edge** in the terminal:
