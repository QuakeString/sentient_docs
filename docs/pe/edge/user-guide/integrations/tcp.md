...
assignIntegration:
  ...
  2:
    ...
    title: 'Login to your <b>SENTIENT Edge</b> instance and go to the <b>Integrations center > Integrations</b> section. Confirm the <b>TCP integration</b> on the <b>Edge</b>.'
...
- **TCP Integration**: The integration that runs externally and is connected to the **SENTIENT Edge** instance.
...
An example of the message sent to the device and the response from **SENTIENT Edge** in the terminal:
