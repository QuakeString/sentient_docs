...
google-credentials-for-oauth-1:
    ...
    1:
        ...
        title: 'Enter a OAuth client name, and add the ST-RMQTT redirect URI, to the "Authorized Redirect URIs" section. Then, click "Create";'
    2:
...
google-configuration-of-sentient-google-1:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-1.png
        title: 'Login to your ST-RMQTT instance. Go to the "OAuth 2.0" page of the "Security" section. While on the "Domains" tab, click the "plus" icon;'
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-2.png
        title: 'Enter your domain name or IP address of your ST-RMQTT instance. Click "Create new" in the "OAuth 2.0 clients" section to add a new one.'

google-configuration-of-sentient-google-2:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-3.png
    ...
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-4.png
...
google-configuration-of-sentient-google-3:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-5.png
...
google-configuration-of-sentient-google-4:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-6.png
        title: 'The OAuth client is added successfully. Click "Add" again to confirm the addition of the domain;'
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-7.png
        title: 'A new domain has been added.'

login-with-google-1:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/login-with-google-1.png
        title: 'Navigate to the ST-RMQTT login screen. We will see an additional "Login with Google" option. Click this button and login using your Google account;'
...
auth0-credentials-1:
    ...
    1:
        ...
        title: 'Name your application "ST-RMQTT", and choose the application type - "Regular Web Applications";'
    2:
...
oauth0-configuration-of-sentient-1:
    ...
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/google-configuration-of-sentient-2.png
        title: 'Enter your domain name of your ST-RMQTT instance. Click "Create new" in the "OAuth 2.0 clients" section to add a new one.'

oauth0-configuration-of-sentient-2:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-sentient-3.png
...
oauth0-configuration-of-sentient-3:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-sentient-4.png
...
oauth0-configuration-of-sentient-4:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-sentient-5.png
        title: 'The OAuth0 client has been successfully added. Click "Add" again to confirm the addition of the domain.'
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/oauth0-configuration-of-sentient-6.png
        title: 'A new domain has been added.'
...
keycloak-add-sentient-oauth-client-1:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/adding-oauth2-client-1.png
        title: 'Login to your ST-RMQTT instance. Navigate to the "OAuth 2.0" in the "Security" menu section, open "OAuth 2.0 clients" tab, and click "plus" icon to add a new client;'
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-configuration-of-sentient-2.png
...
keycloak-add-sentient-oauth-client-2:
    0:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-configuration-of-sentient-3.png
    ...
    1:
        image: /images/pe/mqtt-broker/user-guide/oauth-2-support/keycloak-configuration-of-sentient-4.png
...
keycloak-add-domain:
    0:
        ...
        title: 'Navigate to the "Domains" tab, and click "plus" icon. Enter your domain name or IP address of your ST-RMQTT instance. Specify "Keycloak" as the OAuth 2.0 client. Click "Add" again to confirm the addition of the domain;'
    1:
...
login-with-keycloak-1:
    0:
        ...
        title: 'Go to the ST-RMQTT login screen. You will see an additional option, "Login with Keycloak". Click this button and login using your Keycloak credentials;'
