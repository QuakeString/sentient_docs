...
title: Sentient PE v4.3.x release notes
description: Discover Sentient PE v4.3.x release notes
breadcrumbs: 'true'
breadcrumbs-steps: '1'
lts: 'true'
...
latest-patch: v4.3.1.1 (Mar 31 2026)
effective-url: '/docs/pe/releases/releases-table/'
---
* TOC
{:toc}

{% include docs/pe/releases/releases-table/v4-3-1-1.md %}
