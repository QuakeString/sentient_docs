...
entityLimits:
    0:
        image: /images/user-guide/tenant-profile/sentient-pe-tenant-profiles-entity-limits.png  

api-limits:
    0:
        image: /images/user-guide/tenant-profile/sentient-pe-api-limits.png

apiLimitsDashboard:
    0:
        image: /images/user-guide/tenant-profile/sentient-pe-tenant-profiles-api-limits-dashboard.png  

rateLimits:
    0:
        image: /images/user-guide/tenant-profile/sentient-pe-rate-limits.png
        
files-limits:
    0:
        image: /images/user-guide/tenant-profile/sentient-pe-files.png

isolatedQueueConfiguration:
    0:
        image: /images/user-guide/tenant-profile/queue-tenant-profile-1-pe.png
        title: 'Step 1. Open tenant profile menu and add new tenant profile. Click "isolated SENTIENT RuleEngine" box, Main queue added by default and can not be renamed or deleted.'
    1:
