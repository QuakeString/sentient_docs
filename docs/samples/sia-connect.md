...
creating-device-on-sentient:
    0:
        ...
        title: 'Login to your SENTIENT instance, and navigate to the "<b>Devices</b>" page of the "<b>Entities</b>" section. By default, will be redirected to the "<b>All</b>" device group. Click on the "<b>plus</b>" icon in the top right corner of the table and then select "<b>Add new device</b>" from drop-down menu;'
    1:
    ...
    3:
        ...
        title: 'A window will open where you can check the device&#39;s connection to SENTIENT. Close this window by clicking "<b>Close</b>" button;'
    4:
...
adding-sentient-instance-1:
    0:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-1-paas.png
    ...
    1:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-2-paas.png
        title: 'SENTIENT instance has been added.'

adding-sentient-instance-2:
    0:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-3-paas.png
        title: 'Click on the "<b>+ New item</b>" in the "<b>Items</b>" section;'
    1:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-4-paas.png
...
adding-sentient-instance-3:
    0:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-5-paas.png
        title: 'Click on the "<b>+ New mapping</b>" in the "<b>Mappings on SENTIENT</b>" section;'
    1:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-6-paas.png
        title: 'For "<b>Sender Item</b>" select "<b>OPC-UA Device</b>" as instance and "<b>Temperature</b>" as "<b>Item</b>". For "<b>Receiver item</b>" select "<b>SENTIENT</b>" as "<b>Instance</b>" and "<b>Publish data</b>" as "<b>Item</b>". Click on "<b>Save mapping</b>" button. Mapping has been added.'

adding-sentient-instance-4:
    0:
        image: /images/user-guide/integrations/sia-connect/adding-sentient-instance-7-paas.png
        title: 'Add other mappings, such as "<b>Power</b>" and "<b>Humidity</b>".'
  
check-data-on-sentient:
    0:
        image: /images/user-guide/integrations/sia-connect/check-data-on-sentient-1-paas.png
        title: 'Navigate to the "<b>Devices</b>" page of the "<b>Entities</b>" section of your <b>SENTIENT</b> instance, and click on the OPC-UA Device row in the table to open device details. Navigate to the "<b>Latest telemetry</b>" tab. You must see incoming data.'

shared-attributes:
    0:
        image: /images/user-guide/integrations/sia-connect/shared-attributes-1-paas.png
        title: 'Go to the "<b>Instance</b>" tab in the side menu and select "<b>SENTIENT</b>";'
    1:
...
create-another-mapping:
    0:
        ...
        title: 'On the <b>SENTIENT</b> instance, scroll down to "<b>Mappings</b>" section and click on "<b>+ New Mapping</b>" button;'
    1:
        image: /images/user-guide/integrations/sia-connect/create-another-mapping-2-paas.png
        title: 'For "<b>Sender Item</b>" select "<b>SENTIENT</b>" as instance and "<b>Shared attribute update</b>" as "<b>Item</b>". For "<b>Receiver item</b>" select "<b>OPC-UA Device</b>" as instance and "<b>Status</b>" as "<b>Item</b>". Paste "<b>%VALUE.status%</b>" to the "<b>Custom value</b>" field. Click on "<b>Save mapping</b>" button;'
...
import-dashboard:
    0:
        ...
        title: 'Go to the "<b>Dashboard</b>" page of your "<b>SENTIENT</b>" instance. By default, you will be redirected to the "<b>All</b>" device group. Click on the "<b>plus</b>" icon in the top right corner of the table and then select "<b>Import dashboard</b>" from drop-down menu;'
    1:
