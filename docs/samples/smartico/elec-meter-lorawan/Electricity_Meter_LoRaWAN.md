...
description: SENTIENT IoT Platform sample for electricity data upload over MQTT using Smart Meter "Smartico E307".
hidetoc: "true"
---
...
Browse other [samples](/docs/samples){:target="_blank"} or explore guides related to main SENTIENT features:
