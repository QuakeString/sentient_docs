...
title: Interacting with SENTIENT ANALYTICS AI Assistant
description: Step-by-step guide to interact with SENTIENT ANALYTICS AI Assistant.

sentient-analytics-assistance-overview:
  0:
    image: /images/sentient-analytics/ai/overview-1.png
    title: 1. Press “New Chat”
  1:
    image: /images/sentient-analytics/ai/overview-2.png
  ...
  2:
    image: /images/sentient-analytics/ai/overview-3.png
    title: 3. Write and send the question.
  3:
    image: /images/sentient-analytics/ai/overview-4.png
    title: 4. See the result.
  4:
    image: /images/sentient-analytics/ai/overview-5.png
    title: 5. If needed, write and send additional specifications to refine the response.

sentient-analytics-assistance-capabilities-visualization:
  0:
    image: /images/sentient-analytics/ai/capabilities/1-simple-table.png
    title: Table (without dynamic columns)
  1:
    image: /images/sentient-analytics/ai/capabilities/2-dynamic-table.png
    title: Table (with dynamic columns)
  2:
    image: /images/sentient-analytics/ai/capabilities/3-line.png
    title: Line Chart
  3:
    image: /images/sentient-analytics/ai/capabilities/4-pie.png
    title: Pie Chart
  4:
    image: /images/sentient-analytics/ai/capabilities/5-bar.png
    title: Vertical Bar Chart
  5:
    image: /images/sentient-analytics/ai/capabilities/6-stacked-bar.png
    title: Stacked Bar Chart
  6:
    image: /images/sentient-analytics/ai/capabilities/7-horizontal-bar.png
    title: Horizontal Bar Chart
  7:
    image: /images/sentient-analytics/ai/capabilities/8-scatter-plot.png
    title: Scatter Plot
  8:
    image: /images/sentient-analytics/ai/capabilities/9-heatmap.png
    title: Heatmap
  9:
    image: /images/sentient-analytics/ai/capabilities/10-heatmap-calendar.png
    title: Heatmap Calendar
  10:
    image: /images/sentient-analytics/ai/capabilities/11-card.png
    title: Card
  11:
    image: /images/sentient-analytics/ai/capabilities/12-card-with-line.png
    title: Card With Line

sentient-analytics-assistance-capabilities-date-picker:
  0:
    image: /images/sentient-analytics/ai/capabilities/13-date-picker.png
    title: Apply a date picker

sentient-analytics-assistance-capabilities-date-fields:
  0:
    image: /images/sentient-analytics/ai/capabilities/14-date-fields.png
    title: Use date fields

sentient-analytics-assistance-capabilities-view-name:
  0:
    image: /images/sentient-analytics/ai/capabilities/15-view-name.png
    title: Assign a name for each column and visualization

sentient-analytics-assistance-capabilities-filter:
  0:
    image: /images/sentient-analytics/ai/capabilities/16-filter.png
    title: Add filters

sentient-analytics-assistance-capabilities-foreign-language:
  0:
    image: /images/sentient-analytics/ai/capabilities/17-foreign-language.png
    title: Answer questions in different languages

sentient-analytics-assistance-chat-page:
  0:
    image: /images/sentient-analytics/ai/chat-page-1.png
  ...
  1:
    image: /images/sentient-analytics/ai/chat-page-2.png
    title: If it is necessary it is possible to change the generated time range.
  2:
    image: /images/sentient-analytics/ai/chat-page-3.png
    title: If it is necessary it is possible to change or remove generated filters.

sentient-analytics-assistance-send-new-msg:
  0:
    image: /images/sentient-analytics/ai/send-message-1.png
    title: You can type your message, and send it by clicking the *Send* icon on the right side of the input field.
  1:
    image: /images/sentient-analytics/ai/send-message-2.png
    title: See the result.

sentient-analytics-assistance-edit-msg:
  0:
    image: /images/sentient-analytics/ai/edit-message-1.png
    title: Press on the pencil icon on the left of the last message.
  1:
    image: /images/sentient-analytics/ai/edit-message-2.png
  ...
  2:
    image: /images/sentient-analytics/ai/edit-message-3.png
    title: See the result.

sentient-analytics-assistance-check-msg:
  0:
    image: /images/sentient-analytics/ai/check-message-1.png
...
sentient-analytics-assistance-rerun-answer:
  0:
    image: /images/sentient-analytics/ai/rerun-answer.png
    title: Click the "Refresh" button at the top right of the message block to regenerate the assistant's answer.

sentient-analytics-assistance-check-interpretation:
  0:
    image: /images/sentient-analytics/ai/check-interpretation-1.png
    title: You can click the "Assistant's Interpretation" label at the top left of the message.
  1:
    image: /images/sentient-analytics/ai/check-interpretation-2.png
    title: See the interpretation.

sentient-analytics-assistance-save-config:
  0:
    image: /images/sentient-analytics/ai/chat-save-config-1.png
    title: Press the “Save config” button.
  1:
    image: /images/sentient-analytics/ai/chat-save-config-2.png
    title: Choose the view collection where you want to save the generated view config and click the "Save" button.

sentient-analytics-assistance-check-view-config:
  0:
    image: /images/sentient-analytics/ai/check-view-config-1.png
    title: Click the "See Details" button at the top right of the screen to review the generated view.
  1:
    image: /images/sentient-analytics/ai/check-view-config-2.png
    title: Click the "Settings" button in the top right corner of the screen to access additional settings.
  2:
    image: /images/sentient-analytics/ai/check-view-config-3.png
    title: Click the "Back" button to exit this tab.

sentient-analytics-assistance-generate-chat-summary:
  0:
    image: /images/sentient-analytics/ai/generate-chat-summary-1.png
    title: Click the "Get Chat Summary" button at the top right of the screen.
  1:
    image: /images/sentient-analytics/ai/generate-chat-summary-2.png
    title: The chat summary will appear at the top of the screen.

sentient-analytics-assistance-topology:
  0:
    image: /images/sentient-analytics/ai/chat-topology-1.png
  ...
  1:
    image: /images/sentient-analytics/ai/chat-topology-2.png
    title: Specify which business entities or business entity fields AI Assistance needs to know.
  2:
    image: /images/sentient-analytics/ai/chat-topology-3.png
...
1. To access AI Assistance, click on the icon![image](/images/sentient-analytics/ai/overview-ai-assistance-icon.png) labeled *Assistant*
...
{% include images-gallery.html imageCollection="sentient-analytics-assistance-overview" %}
...
* Card with line
  {% include images-gallery.html imageCollection="sentient-analytics-assistance-capabilities-visualization" %}

**2.Apply a date picker**

Apply a date picker (by default for this week):
{% include images-gallery.html imageCollection="sentient-analytics-assistance-capabilities-date-picker" %}

**3.Use date fields**
{% include images-gallery.html imageCollection="sentient-analytics-assistance-capabilities-date-fields" %}

**4.Assign a name for each column and visualization**
{% include images-gallery.html imageCollection="sentient-analytics-assistance-capabilities-view-name" %}

**5.Add filters**
{% include images-gallery.html imageCollection="sentient-analytics-assistance-capabilities-filter" %}

**6.Answer questions in different languages**
{% include images-gallery.html imageCollection="sentient-analytics-assistance-capabilities-foreign-language" %}
...
{% include images-gallery.html imageCollection="sentient-analytics-assistance-chat-page" %}
...
* **Type and send a new message**:
  * You can type your message, and send it by clicking the *Send* icon on the right side of the input field.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-send-new-msg" %}
...
* **Edit the last message**:
  ...
  * This can be useful if the AI Assistant returned incorrect results, and you want to provide more details in the same message.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-edit-msg" %}
...
* **Check the selected message**:
  * You can click on any message to view its previously generated answer on the right side of the screen.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-check-msg" %}
...
* **Regenerate the answer**:
  ...
  * This can be helpful if the response was incorrect.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-rerun-answer" %}
...
* **Check Assistant's Interpretation**:
  ...
  * This can help verify whether the AI Assistant correctly understood your request.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-check-interpretation" %}

* **Save Config**:
  * You can use this button to save the generated view to a selected view collection.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-save-config" %}
...
* **Review Generated View**:
  ...
  * This helps verify whether the AI Assistant correctly selected Business Entities, Business Entity Fields, and Aggregations.
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-check-view-config" %}
...
* **Generate Chat Summary**:
  ...
  * This feature helps analyze and identify anomalies or correlations in the generated view.  
    {% include images-gallery.html imageCollection="sentient-analytics-assistance-generate-chat-summary" %}
...
{% include images-gallery.html imageCollection="sentient-analytics-assistance-topology" %}
...
The number of messages you can send each month depends on your subscription type. When you`re using the SENTIENT ANALYTICS AI model on the cloud, there are no additional charges.

To not be related to these limits, it’s possible to use your own model. To find out how to not be related to these limits, refer to the [Custom AI Model Configuration page](/docs/sentient-analytics/custom-ai-model-configuration/) for more details.
...
It’s impossible to use the default large language model for self-hosted clients. To find out how to enable the AI Assistant feature for self-hosted installation, please refer to the [Custom AI Model Configuration page](/docs/sentient-analytics/custom-ai-model-configuration/).
