...
Add iFrame on your site with the following URL **http://{SENTIENT_ANALYTICS_URL}/viewMode/{VIEW_ID}?jwt={JWT_TOKEN}**. Where:
* SENTIENT_ANALYTICS_URL - url of SENTIENT ANALYTICS service
