...
Assembly machines already connected to SENTIENT via OPC-UA integration and telemetry data is available in SENTIENT. You can find more details how to do this in our [connectivity guides](https://sentient.invenia.in/docs/pe/guides/#AnchorIDConnectYourDevice).
