...
title: SENTIENT ANALYTICS v1.11.x upgrade instructions for CentOS
description: SENTIENT ANALYTICS v1.11.x upgrade guide for CentOS
...
{% include resources.liquid version="1.11.2" kind="centos-download" sentient-analytics="true" %}

#### SENTIENT ANALYTICS service upgrade

* Install SENTIENT ANALYTICS service

{% include resources.liquid version="1.11.2" kind="centos-installation" sentient-analytics="true" %}
...
{% include resources.liquid version="1.11.1" kind="centos-download" sentient-analytics="true" %}

#### SENTIENT ANALYTICS service upgrade

* Install SENTIENT ANALYTICS service

{% include resources.liquid version="1.11.1" kind="centos-installation" sentient-analytics="true" %}
...
{% include resources.liquid version="1.11.0" kind="centos-download" sentient-analytics="true" %}
...
{% include resources.liquid version="1.11.0" kind="centos-installation" sentient-analytics="true" %}
