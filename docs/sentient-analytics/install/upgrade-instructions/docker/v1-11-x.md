...
title: SENTIENT ANALYTICS v1.11.x upgrade instructions for Docker
description: SENTIENT ANALYTICS v1.11.x upgrade guide for Docker
...
**NOTE**: You can upgrade SENTIENT ANALYTICS from any version to the 1.11.2.
{% endcapture %}
...
```bash
docker pull sentient/sentient-analytics:1.11.2
```
{: .copy-code}
...
{% capture dockerComposeStandalone %}
If you still rely on Docker Compose as docker-compose (with a hyphen) execute next command:
<br>**docker-compose exec mysentient-analytics sh -c "echo '1.11.1' > /data/.upgradeversion"**
{% endcapture %}
{% include templates/info-banner.md content=dockerComposeStandalone %}
...
< . . . >
  sentient-analytics:
    image: "sentient/sentient-analytics:1.11.2"
  sentient-analytics-python-executor:
    image: "sentient/sentient-analytics-python-executor:1.11.2"  
< . . . >
```
{: .copy-code}
...
{% capture upgrade_version_by_version%}
**NOTE**: You can upgrade SENTIENT ANALYTICS from any version to the 1.11.1.
{% endcapture %}
{% include templates/info-banner.md content=upgrade_version_by_version %}
...
```bash
docker pull sentient/sentient-analytics:1.11.1
```
{: .copy-code}
...
{% capture dockerComposeStandalone %}
If you still rely on Docker Compose as docker-compose (with a hyphen) execute next command:
<br>**docker-compose exec mysentient-analytics sh -c "echo '1.11.0' > /data/.upgradeversion"**
{% endcapture %}
{% include templates/info-banner.md content=dockerComposeStandalone %}
...
< . . . >
  sentient-analytics:
    image: "sentient/sentient-analytics:1.11.1"
  sentient-analytics-python-executor:
    image: "sentient/sentient-analytics-python-executor:1.11.1"  
< . . . >
```
{: .copy-code}
...
{% capture upgrade_version_by_version%}
**NOTE**: You can upgrade SENTIENT ANALYTICS from any version to the 1.11.0.
{% endcapture %}
{% include templates/info-banner.md content=upgrade_version_by_version %}
...
```bash
docker pull sentient/sentient-analytics:1.11.0
```
{: .copy-code}
...
{% capture dockerComposeStandalone %}
If you still rely on Docker Compose as docker-compose (with a hyphen) execute next command:
<br>**docker-compose exec mysentient-analytics sh -c "echo '1.10.3-HF7' > /data/.upgradeversion"**
{% endcapture %}
{% include templates/info-banner.md content=dockerComposeStandalone %}
...
< . . . >
  sentient-analytics:
    image: "sentient/sentient-analytics:1.11.0"
  sentient-analytics-python-executor:
    image: "sentient/sentient-analytics-python-executor:1.11.0"  
< . . . >
```
{: .copy-code}
