...
Download SENTIENT ANALYTICS installation package for Windows: [sentient-analytics-windows-1.12.0.zip](https://dist.sentient.invenia.in/sentient-analytics-windows-1.12.0.zip).
