...
Download SENTIENT ANALYTICS installation package for Windows: [sentient-analytics-windows-1.8.2.zip](https://dist.sentient.invenia.in/sentient-analytics-windows-1.8.2.zip).
...
Download SENTIENT ANALYTICS installation package for Windows: [sentient-analytics-windows-1.8.1.zip](https://dist.sentient.invenia.in/sentient-analytics-windows-1.8.1.zip).
