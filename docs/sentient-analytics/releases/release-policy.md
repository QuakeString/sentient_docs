...
<span class="code-light">1.15.0.0</span> — Initial 1.15 LTS release

<span class="code-light">1.15.0.2</span> — Two hotfixes later, no upgrade scripts required to move within <span class="code-light">1.15.0.x</span>
