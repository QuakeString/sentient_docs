...
- vparomskiy
title: States
description: SENTIENT ANALYTICS States
---
...
<div id="video">  
    <div  id="video_wrapper">
        <iframe referrerpolicy="strict-origin-when-cross-origin" src="https://www.youtube.com/embed/FrubZ-odF1s" frameborder="0" allowfullscreen></iframe>
    </div>
</div>
...
![image](/images/sentient-analytics/state-simple-view.png)
...
![image](/images/sentient-analytics/state-simple-config-drop.png)

![image](/images/sentient-analytics/state-simple-config.png)

Our view ready and now we know how much time(in percent) machines spent in different states.

<div class="image-block">
    <div class="image-wrapper">
       <video poster="/images/sentient-analytics/state-simple-view.png" autoplay="" loop="" preload="auto" muted="" style="width: 750px">
...
![image](/images/sentient-analytics/state-multiple-view.png)
...
<div class="image-block">
    <div class="image-wrapper">
       <video poster="/images/sentient-analytics/state-multiple-view.png" autoplay="" loop="" preload="auto" muted="" style="width: 750px">
