...
sentient-analytics-js-summary-module-install:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/install-sentient-analytics-js-module-1.png
    title: "Open the Settings page in the SENTIENT ANALYTICS App and click the Upload Module button."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/install-sentient-analytics-js-module-2.png
    title: "Confirm that the module has been uploaded successfully and appears in the list."

sentient-ai-widget-summary:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-1.png
    title: "Open the dashboard containing your widget. Switch to <b>Edit mode</b>."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-2.png
    title: "Click <b>Edit Widget</b> on widget you want to add custom AI summary action."
  2:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-3.png
    title: "Go to the <b>Actions</b> tab and click <b>Add action</b>."
  3:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-4.png
    title: "Configure: <b>Action source</b>, <b>Name</b>, <b>Button icon</b> and <b>Action</b>."

sentient-ai-widget-summary-v3.9:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-v3.9-1.png
    title: "Click <b>Modules</b> than click <b>Add module</b>. Set <b>Alias</b> as <b>sentient-analytics</b> and <b>JS module resource</b> as <b>SENTIENT ANALYTICS AI Summary Module</b>. Than click <b>Apply</b>."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-v3.9-2.png
    title: "In the custom action code field, add <b>sentient-analytics.getAnalytics(widgetContext, true);</b>, than click <b>Add</b>."
  2:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-common-1.png
    title: "Click <b>Apply</b>."
  3:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-common-2.png
    title: "Click <b>Save</b>."
  4:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-common-3.png
    title: "Verify that a new button appears in your widget header."


sentient-ai-widget-summary-v3.6:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-v3.6.png
    title: "Manually copy the full JavaScript code from <b>`custom-action-ai-summary.js`</b> into your custom action field. At the end of the custom action code field, add <b>sentient-analytics.getAnalytics(widgetContext, true);</b>. Than click <b>Add</b>."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-ai-widget-summary-common-1.png
    title: "Click <b>Apply</b>."
  2:
...
sentient-analytics-ai-summary-sentient-analytics-widget-example:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-widget-example-1.png
    title: "1. Press the 'AI summary' button in the upper corner of the widget."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-widget-example-2.png
    title: "2. See view the AI summary at the top of the SENTIENT ANALYTICS widget."

sentient-analytics-ai-summary-sentient-analytics-enable-button:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-setting-common.png
    title: "Open the desired view. Go to 'View Settings'."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-enable-button-1.png
    title: "Go to the 'View Mode Fields' section. Choose the preferred mode to show or hide the AI Summary button."
  2:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-enable-button-2.png
    title: "Save the changes."

sentient-analytics-ai-summary-sentient-analytics-set-up-prompt:
  0:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-setting-common.png
    title: "Open the desired view. Go to 'View Settings'."
  1:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-set-up-prompt-1.png
    title: "Go to the 'AI Assistant' section. Choose the preferred prompt from the dropdown menu." 
  2:
    image: /images/sentient-analytics/ai/widget-ai-summary/sentient-analytics-set-up-prompt-2.png
    title: "Save the changes."
---
...
AI Widget Summary is a dashboard control that turns live SENTIENT telemetry into an immediate, human-readable answer. 
...
{% include images-gallery.html imageCollection="sentient-analytics-js-summary-module-install" %}
...
{% include images-gallery.html imageCollection="sentient-ai-widget-summary" %}
...
{% include images-gallery.html imageCollection="sentient-ai-widget-summary-v3.9" %}
...
{% include images-gallery.html imageCollection="sentient-ai-widget-summary-v3.6" %}

### Using the Custom Action

After configuration, a new button appears in your widget header.
Clicking it opens a dialog showing a summary generated by SENTIENT ANALYTICS AI based on your widget’s data and prompt settings.
...
Learn more about managing prompts in [SENTIENT ANALYTICS AI Prompts Overview](/docs/sentient-analytics/ai-assistance-prompts).

## SENTIENT ANALYTICS Widgets

AI summary is already integrated into the SENTIENT ANALYTICS Widgets. To retrieve the AI summary for a SENTIENT ANALYTICS widget, 
press the **AI summary** button in the upper corner of the screen. After that, you will be able to view the AI summary 
at the top of the SENTIENT ANALYTICS widget.

{% include images-gallery.html imageCollection="sentient-analytics-ai-summary-sentient-analytics-widget-example" %}

### Enable AI Summary Button

By default, the AI summary button is disabled on dashboards for views created before SENTIENT ANALYTICS 1.13.1 and for views created during the 
period when the **AI Assistant Use AI Model** flag was disabled for self-hosted users 
(Find out more about how to set up the AI Assistant module for self-hosted users [here](/docs/sentient-analytics/custom-ai-model-configuration/)).
...
{% include images-gallery.html imageCollection="sentient-analytics-ai-summary-sentient-analytics-enable-button" %}
...
{% include images-gallery.html imageCollection="sentient-analytics-ai-summary-sentient-analytics-set-up-prompt" %}

Find out more about creating your own prompts that perfectly fit your task [here](/docs/sentient-analytics/ai-assistance-prompts/).
