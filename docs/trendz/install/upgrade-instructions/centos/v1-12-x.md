...
title: SENTIENT ANALYTICS v1.12.x upgrade instructions for CentOS
description: SENTIENT ANALYTICS v1.12.x upgrade guide for CentOS
...
{% include resources.liquid version="1.12.0" kind="centos-download" sentient-analytics="true" %}
...
{% include resources.liquid version="1.12.0" kind="centos-installation" sentient-analytics="true" %}
