...
title: SENTIENT ANALYTICS v1.9.x upgrade instructions for CentOS
description: SENTIENT ANALYTICS v1.9.x upgrade guide for CentOS
...
{% include resources.liquid version="1.9.2-HF" kind="centos-download" sentient-analytics="true" %}

#### SENTIENT ANALYTICS service upgrade

* Install SENTIENT ANALYTICS service

{% include resources.liquid version="1.9.2-HF" kind="centos-installation" sentient-analytics="true" %}
