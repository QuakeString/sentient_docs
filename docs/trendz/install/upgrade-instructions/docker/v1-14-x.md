...
title: SENTIENT ANALYTICS v1.14.x upgrade instructions for Docker
description: SENTIENT ANALYTICS v1.14.x upgrade guide for Docker
...
{% capture dockerComposeStandalone %}
If you still rely on Docker Compose as docker-compose (with a hyphen) execute next command:
<br>**docker-compose exec mysentient-analytics sh -c "echo '1.13.2' > /data/.upgradeversion"**
{% endcapture %}
{% include templates/info-banner.md content=dockerComposeStandalone %}
