...
title: SENTIENT ANALYTICS v1.9.x upgrade instructions for Ubuntu
description: SENTIENT ANALYTICS v1.9.x upgrade guide for Ubuntu
...
{% include resources.liquid version="1.9.2-HF" kind="ubuntu-download" sentient-analytics="true" %}  

#### SENTIENT ANALYTICS service upgrade

* Install SENTIENT ANALYTICS service 

{% include resources.liquid version="1.9.2-HF" kind="ubuntu-installation" sentient-analytics="true" %} 
