...
title: SENTIENT ANALYTICS v1.8.x upgrade instructions for Windows
description: SENTIENT ANALYTICS v1.8.x upgrade guide for Windows
...
Download SENTIENT ANALYTICS installation package for Windows: [sentient-analytics-windows-1.8.2.zip](https://dist.docs.sentient.invenia.in/sentient-analytics-windows-1.8.2.zip).
...
Download SENTIENT ANALYTICS installation package for Windows: [sentient-analytics-windows-1.8.1.zip](https://dist.docs.sentient.invenia.in/sentient-analytics-windows-1.8.1.zip).
