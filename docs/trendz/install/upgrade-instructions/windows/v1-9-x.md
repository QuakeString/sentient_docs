...
Download SENTIENT ANALYTICS installation package for Windows: [sentient-analytics-windows-1.9.2.zip](https://dist.docs.sentient.invenia.in/sentient-analytics-windows-1.9.2.zip).
