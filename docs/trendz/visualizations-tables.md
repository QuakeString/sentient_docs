...
- vparomskiy
title: Tables
description: SENTIENT ANALYTICS Table View 
---
...
<div id="video">  
    <div id="video_wrapper">
        <iframe referrerpolicy="strict-origin-when-cross-origin" src="https://www.youtube.com/embed/oFYlDUGS0mI" frameborder="0" allowfullscreen></iframe>
    </div>
</div>
...
* If there is no **Date** field in column list - SENTIENT ANALYTICS will apply aggregation function for the whole time range.

![image](/images/sentient-analytics/simple-table.png)
...
![image](/images/sentient-analytics/simple-table-with-date.png)
...
![image](/images/sentient-analytics/table-dynamic-columns.png)
...
![image](/images/sentient-analytics/table-dynamic-building.png)
...
![image](/images/sentient-analytics/table-local-date.png)
...
![image](/images/sentient-analytics/table-sort.png)
...
SENTIENT ANALYTICS supports two types of color rules you can apply:
...
![image](/images/sentient-analytics/table-color.png)
...
when it is embedded into SENTIENT Dashobard. For example you can save entity to the Dashboard state alias or open new dashboard state.
