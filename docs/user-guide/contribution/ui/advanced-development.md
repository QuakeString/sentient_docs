...
add-js-module:
    ...
    1:
        ...
        title: 'Congratulations, your components were added to the SENTIENT!'
...
select-extensions-module:
    ...
    5:
        ...
        title: 'Add the following code to the "onDataUpdate" function: "self.ctx.$scoce.exampleTableComponent.onDataUpdated();"'
    6:
