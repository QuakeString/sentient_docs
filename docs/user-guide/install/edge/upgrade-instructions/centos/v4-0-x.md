...
title: SENTIENT GATEWAY CE v4.0.x upgrade instructions for CentOS
description: SENTIENT GATEWAY CE v4.0.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v4-0-x/#upgrading-sentient-ce-to-401" %}
