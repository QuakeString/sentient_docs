...
title: SENTIENT GATEWAY CE v3.3.x upgrade instructions for Docker
description: SENTIENT GATEWAY CE v3.3.x upgrade guide for Docker
...
{% assign versionName = "3.3.4.1EDGE" %}
{% assign previousVersion = "3.3.4EDGE" %}
{% assign updateServerLink = "docker/v3-3-x/#upgrading-sentient-ce-to-3341" %}
