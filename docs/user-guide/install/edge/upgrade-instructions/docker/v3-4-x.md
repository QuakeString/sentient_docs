...
title: SENTIENT GATEWAY CE v3.4.x upgrade instructions for Docker
description: SENTIENT GATEWAY CE v3.4.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-4-x/#upgrading-sentient-ce-to-343" %}
...
{% assign updateServerLink = "docker/v3-4-x/#upgrading-sentient-ce-to-341" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% capture edge-previousVersion %}
These steps are applicable for Edge {{previousVersion}} version.
{% endcapture %}
...
{% assign updateServerLink = "docker/v3-4-x/#upgrading-sentient-ce-to-34" %}
{% include templates/edge/install/compatibility-warning-version.md %}
