...
title: SENTIENT GATEWAY CE v3.6.x upgrade instructions for Docker
description: SENTIENT GATEWAY CE v3.6.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-6-x/#upgrading-sentient-ce-to-364" %}
...
{% assign updateServerLink = "docker/v3-6-x/#upgrading-sentient-ce-to-363" %}
{% include templates/edge/install/compatibility-warning-version.md %}
...
{% assign updateServerLink = "docker/v3-6-x/#upgrading-sentient-ce-to-362" %}
{% include templates/edge/install/compatibility-warning-version.md %}
...
services:
  mytbedge:
    restart: on-failure
    image: "sentient/tb-edge:{{versionName}}"
    environment:
...
{% assign updateServerLink = "docker/v3-6-x/#upgrading-sentient-ce-to-361" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% capture edge-previousVersion %}
These steps are applicable for Edge {{previousVersion}} version.
{% endcapture %}
...
```
docker pull sentient/tb-edge:{{versionName}}
```
{: .copy-code}
...
{% assign updateServerLink = "docker/v3-6-x/#upgrading-sentient-ce-to-360" %}
{% include templates/edge/install/compatibility-warning-version.md %}
