...
title: SENTIENT GATEWAY CE v3.8.x upgrade instructions for Docker
description: SENTIENT GATEWAY CE v3.8.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-8-x/#upgrading-sentient-ce-to-380" %}
