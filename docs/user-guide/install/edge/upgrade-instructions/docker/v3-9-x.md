...
title: SENTIENT GATEWAY CE v3.9.x upgrade instructions for Docker
description: SENTIENT GATEWAY CE v3.9.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-9-x/#upgrading-sentient-ce-to-391" %}
...
{% assign updateServerLink = "docker/v3-9-x/#upgrading-sentient-ce-to-390" %}
{% include templates/edge/install/compatibility-warning-version.md %}
