...
title: SENTIENT GATEWAY CE v3.3.x upgrade instructions for Ubuntu
description: SENTIENT GATEWAY CE v3.3.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-3-x/#upgrading-sentient-ce-to-3341" %}
