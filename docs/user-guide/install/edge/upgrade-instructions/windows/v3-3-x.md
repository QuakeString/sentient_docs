...
title: SENTIENT Edge CE v3.3.x upgrade instructions for Windows
description: SENTIENT Edge CE v3.3.x upgrade guide for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-3.3.4.1 zip](https://github.com/sentient/sentient-gateway/releases/download/v3.3.4.1/tb-edge-windows-3.3.4.1.zip).
