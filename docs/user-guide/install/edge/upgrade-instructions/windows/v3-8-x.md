...
title: SENTIENT Edge CE v3.8.x upgrade instructions for Windows
description: SENTIENT Edge CE v3.8.x upgrade guide for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-3.8.zip](https://github.com/sentient/sentient-gateway/releases/download/v3.8/tb-edge-windows-3.8.zip).
