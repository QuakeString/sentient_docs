...
title: SENTIENT Edge CE v4.0.x upgrade instructions for Windows
description: SENTIENT Edge CE v4.0.x upgrade guide for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-4.0.1.zip](https://github.com/sentient/sentient-gateway/releases/download/v4.0.1/tb-edge-windows-4.0.1.zip).
