...
title: SENTIENT Edge CE v4.1.x upgrade instructions for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-4.1.zip](https://github.com/sentient/sentient-gateway/releases/download/v4.1/tb-edge-windows-4.1.zip).
