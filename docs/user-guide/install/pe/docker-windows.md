...
assignees:
- ashvayka
title: Installing SENTIENT Professional Edition using Docker (Windows)
description: Installing SENTIENT Professional Edition IoT Platform using Docker (Windows)
...
This guide will help you to install and start SENTIENT Professional Edition (PE) using Docker on Windows. 
...
{% include templates/install/windows-pe-docker-sentient-analytics.md %}
