...
title: SENTIENT GATEWAY PE v3.7.x upgrade instructions for CentOS
description: SENTIENT GATEWAY PE v3.7.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-7-x/#upgrading-sentient-pe-to-37" %}
