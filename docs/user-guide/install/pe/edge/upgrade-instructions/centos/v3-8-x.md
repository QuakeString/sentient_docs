...
title: SENTIENT GATEWAY PE v3.8.x upgrade instructions for CentOS
description: SENTIENT GATEWAY PE v3.8.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v3-8-x/#upgrading-sentient-pe-to-38" %}
