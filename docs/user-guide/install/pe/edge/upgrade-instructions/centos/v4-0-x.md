...
title: SENTIENT Edge PE v4.0.x upgrade instructions for CentOS
description: SENTIENT Edge PE v4.0.x upgrade guide for CentOS
...
{% assign updateServerLink = "centos/v4-0-x/#upgrading-sentient-pe-to-401" %}
