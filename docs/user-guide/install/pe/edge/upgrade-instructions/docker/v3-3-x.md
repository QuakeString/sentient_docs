...
title: SENTIENT GATEWAY PE v3.3.x upgrade instructions for Docker
description: SENTIENT GATEWAY PE v3.3.x upgrade guide for Docker
...
{% assign versionName = "3.3.4.1EDGEPE" %}
{% assign previousVersion = "3.3.4EDGEPE" %}
{% assign updateServerLink = "docker/v3-3-x/#upgrading-sentient-pe-to-3341" %}
