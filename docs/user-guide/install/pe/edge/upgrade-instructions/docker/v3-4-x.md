...
title: SENTIENT GATEWAY PE v3.4.x upgrade instructions for Docker
description: SENTIENT GATEWAY PE v3.4.x upgrade guide for Docker
...
{% assign versionName = "3.4.3EDGEPE" %}
{% assign previousVersion = "3.4.1EDGEPE" %}
{% assign updateServerLink = "docker/v3-4-x/#upgrading-sentient-pe-to-343" %}
...
{% assign versionName = "3.4.1EDGEPE" %}
{% assign previousVersion = "3.4.0EDGEPE" %}
{% assign updateServerLink = "docker/v3-4-x/#upgrading-sentient-pe-to-341" %}
{% assign peDocsPrefix = "pe/" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% capture edge-previousVersion %}
These steps are applicable for Edge {{previousVersion}} version.
...
{% assign versionName = "3.4.0EDGEPE" %}
{% assign previousVersion = "3.3.4.1EDGEPE" %}
{% assign updateServerLink = "docker/v3-4-x/#upgrading-sentient-pe-to-34" %}
{% assign peDocsPrefix = "pe/" %}
{% include templates/edge/install/compatibility-warning-version.md %}
