...
title: SENTIENT Edge PE v3.6.x upgrade instructions for Docker
description: SENTIENT Edge PE v3.6.x upgrade guide for Docker
...
Modify the `docker-compose.yml' file for SENTIENT Edge to update the volume settings.
...
The next step creates a docker compose file for the **SENTIENT Edge upgrade** process and runs the upgrade. 
