...
title: SENTIENT GATEWAY PE v3.7.x upgrade instructions for Docker
description: SENTIENT GATEWAY PE v3.7.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-7-x/#upgrading-sentient-pe-to-370" %}
