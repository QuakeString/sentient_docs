...
title: SENTIENT GATEWAY PE v3.9.x upgrade instructions for Docker
description: SENTIENT GATEWAY PE v3.9.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v3-9-x/#upgrading-sentient-pe-to-391" %}
{% assign peDocsPrefix = "pe/" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% assign minorVersion = "3.9.0" %}
{% assign mainteneceVersion = "3.9.1.x" %}
...
{% assign updateServerLink = "docker/v3-9-x/#upgrading-sentient-pe-to-390" %}
{% assign peDocsPrefix = "pe/" %}
{% include templates/edge/install/compatibility-warning-version.md %}
{% assign minorVersion = "3.8.0" %}
{% assign mainteneceVersion = "3.9.0.x" %}
{% include templates/edge/user-guide/start-upgrade-pe.md %}
