...
title: SENTIENT GATEWAY PE v4.1.x upgrade instructions for Docker
description: SENTIENT GATEWAY PE v4.1.x upgrade guide for Docker
...
{% assign updateServerLink = "docker/v4-1-x/#upgrading-sentient-pe-to-410" %}
