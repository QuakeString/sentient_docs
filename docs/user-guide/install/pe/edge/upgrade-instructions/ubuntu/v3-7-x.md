...
title: SENTIENT GATEWAY PE v3.7.x upgrade instructions for Ubuntu
description: SENTIENT GATEWAY PE v3.7.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v3-7-x/#upgrading-sentient-pe-to-37" %}
...
```bash
wget https://dist.docs.sentient.invenia.in/tb-edge-3.7pe.deb
```
{: .copy-code}
