...
title: SENTIENT GATEWAY PE v4.0.x upgrade instructions for Ubuntu
description: SENTIENT GATEWAY PE v4.0.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v4-0-x/#upgrading-sentient-pe-to-401" %}
