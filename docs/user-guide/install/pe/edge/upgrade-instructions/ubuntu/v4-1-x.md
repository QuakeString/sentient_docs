...
title: SENTIENT GATEWAY PE v4.1.x upgrade instructions for Ubuntu
description: SENTIENT GATEWAY PE v4.1.x upgrade guide for Ubuntu
...
{% assign updateServerLink = "ubuntu/v4-1-x/#upgrading-sentient-pe-to-41" %}
...
```bash
wget https://dist.docs.sentient.invenia.in/tb-edge-4.1pe.deb
```
{: .copy-code}
