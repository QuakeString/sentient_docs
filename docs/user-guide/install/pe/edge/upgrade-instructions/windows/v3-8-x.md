...
title: SENTIENT Edge PE v3.8.x upgrade instructions for Windows
description: SENTIENT Edge PE v3.8.x upgrade guide for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-3.8pe.zip](https://dist.docs.sentient.invenia.in/tb-edge-windows-3.8pe.zip).
