...
title: SENTIENT Edge PE v4.0.x upgrade instructions for Windows
description: SENTIENT Edge PE v4.0.x upgrade guide for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-4.0.1pe.zip](https://dist.docs.sentient.invenia.in/tb-edge-windows-4.0.1pe.zip).
