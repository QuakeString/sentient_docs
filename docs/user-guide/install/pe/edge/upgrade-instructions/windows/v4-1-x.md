...
title: SENTIENT Edge PE v4.1.x upgrade instructions for Windows
...
Download SENTIENT Edge package for Windows: [tb-edge-windows-4.1pe.zip](https://dist.docs.sentient.invenia.in/tb-edge-windows-4.1pe.zip).
