---
layout: docwithnav
title: SENTIENT v3.4.x upgrade instructions for Docker Compose
description: SENTIENT v3.4.x upgrade guide for Docker Compose
...
**NOTE:**
<br>
These upgrade steps are applicable for SENTIENT version 3.3.4.1. In order to upgrade to 3.4 you need to [**upgrade to 3.3.4.1 first**](/docs/user-guide/install/upgrade-instructions/docker-compose/v3-3-x/#upgrading-sentient-ce-to-3341).
{% endcapture %}
{% include templates/info-banner.md content=difference %}
