---
layout: docwithnav
title: SENTIENT v3.7.x upgrade instructions for Docker Compose
description: SENTIENT v3.7.x upgrade guide for Docker Compose
...
**NOTE:**
<br>
These upgrade steps are applicable for SENTIENT version 3.6.4. In order to upgrade to 3.7 you need to [**upgrade to 3.6.4 first**](/docs/ce/user-guide/install/upgrade-instructions/docker-compose/v3-6-x/#upgrading-sentient-ce-to-364).
{% endcapture %}
...
{% include docs/user-guide/install/docker-compose-upgrade-steps-fromversion.md version="3.7.0" fromversion="3.6.4" %}