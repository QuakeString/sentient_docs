...
google-configuration-of-sentient-google-1:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-1-ce.png
    ...
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-2-ce.png
...
google-configuration-of-sentient-google-2:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-3-ce.png
    ...
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-4-ce.png
...
google-configuration-of-sentient-google-3:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-5-ce.png
...
google-configuration-of-sentient-google-4:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-6-ce.png
        title: 'OAuth client is added. Click "Add" to confirm adding domain.'
    1:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/google-configuration-of-sentient-7-ce.png
        title: ''

login-with-google-1:
    0:
        image: /images/user-guide/oauth-2-support/google/configuration-of-sentient/login-with-google-1-ce.png
    ...
    2:
        ...
        title: 'You are now logged into SENTIENT using your Google email as a Tenant Administrator.'
...
oauth0-configuration-of-sentient-2:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-3-ce.png
...
oauth0-configuration-of-sentient-3:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-4-ce.png
...
oauth0-configuration-of-sentient-4:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-5-ce.png
        title: 'The OAuth0 client has been successfully added. Click "Add" again to confirm the addition of the domain.'
    1:
        image: /images/user-guide/oauth-2-support/oauth0/configuration-of-sentient/oauth0-configuration-of-sentient-6-ce.png
        title: 'A new domain has been added.'

login-with-oauth0-1:
    0:
        image: /images/user-guide/oauth-2-support/oauth0/login-with-oauth0-1-ce.png
    ...
    1:
        image: /images/user-guide/oauth-2-support/oauth0/login-with-oauth0-2-ce.png
...
keycloak-add-sentient-oauth-client-1:
    0:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-1-ce.png
    ...
    1:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-2-ce.png
...
keycloak-add-sentient-oauth-client-2:
    0:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-3-ce.png
        title: 'Go to the "Mapper" block. Leave the mapper type "BASIC". Select "CUSTOM" as the tenant name strategy. Specify %{email} as tenant name pattern. Click "Add" to confirm adding the OAuth 2 client;'
    1:
        image: /images/user-guide/oauth-2-support/keycloak/keycloak-configuration-of-sentient-4-ce.png
