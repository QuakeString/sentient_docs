...
entityLimits:
    0:
        image: /images/user-guide/tenant-profile/sentient-ce-tenant-profiles-entity-limits.png

api-limits:
    0:
        image: /images/user-guide/tenant-profile/sentient-ce-api-limits.png

apiLimitsDashboard:
    0:
        image: /images/user-guide/tenant-profile/sentient-ce-tenant-profiles-api-limits-dashboard.png  

rateLimits:
    0:
        image: /images/user-guide/tenant-profile/sentient-ce-rate-limits.png  

files-limits:
    0:
        image: /images/user-guide/tenant-profile/sentient-ce-files.png
