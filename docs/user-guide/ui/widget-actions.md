...
description: SENTIENT dashboard widget actions
...
open-url-2:
    ...
    1:
        ...
        title: 'You will be transferred to the URL specified in the action. In our case, it&#39;s the "Working with SENTIENT widgets" documentation page.'
...
on-node-selected-1:
    0:
        image: /images/user-guide/ui/widgets/actions/guide/sources/on-node-selected-1-ce.png
...
mob-layout-5:
    0:
        ...
        title: 'Open this dashboard in your SENTIENT Mobile Application. In the "Entity table" widget click a row of any entity. You will be moved directly to the "Time series chart" widget where you can see the details of the selected entity of the main widget.'
