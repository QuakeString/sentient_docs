...
When purchasing perpetual fallback license, you get one year of software updates included to eternal usage of SENTIENT Professional Edition. After the first year the customer can continue using the platform and purchase software updates for subsequent year for the discount fee.

Single perpetual fallback license covers single SENTIENT Professional Edition instance (server process). 
So, if you like to run SENTIENT Professional Edition in a HA mode, you will need at least two licenses. 
