...
description: Users in SENTIENT License Server
...
The way for creating a new user as same as any customer os user account in SENTIENT Professional Edition. Press ***Add User*** , fill the required fields and send the ***Activation link*** to the user.    
