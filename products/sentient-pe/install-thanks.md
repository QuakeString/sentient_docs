...
<div id="install-thanks" class="center">
    <div class="thanks-content">
        ...
        <div id="maker-form" class="instructions" style="display: none;">
            ...
            <p class="center"><a target="_blank" href="https://aws.amazon.com/marketplace/pp/B07MLRVF3Q">SENTIENT Professional Edition Maker</a></p>
            <br>
            <p>For detailed installation instructions please visit:</p>
            <p class="center"><a href="/docs/user-guide/install/pe/aws-marketplace/">Installing SENTIENT Professional Edition on AWS</a></p>
        </div>    
        <div id="prototype-form" class="instructions" style="display: none;">
            <p>In order to proceed please visit the official product page on AWS marketplace:</p>
            <p class="center"><a target="_blank" href="https://aws.amazon.com/marketplace/pp/B07MLS5VMB">SENTIENT Professional Edition Prototype</a></p>
            <br>
            <p>For detailed installation instructions please visit:</p>
            <p class="center"><a href="/docs/user-guide/install/pe/aws-marketplace/">Installing SENTIENT Professional Edition on AWS</a></p>
        </div>    
        <div id="startup-form" class="instructions" style="display: none;">
            <p>In order to proceed please visit the official product page on AWS marketplace:</p>
            <p class="center"><a target="_blank" href="https://aws.amazon.com/marketplace/pp/B07MQ1G36K">SENTIENT Professional Edition Startup</a></p>
            <br>
            <p>For detailed installation instructions please visit:</p>
            <p class="center"><a href="/docs/user-guide/install/pe/aws-marketplace/">Installing SENTIENT Professional Edition on AWS</a></p>
        </div>    
        <div id="business-form" class="instructions" style="display: none;">
            <p>In order to proceed please visit the official product page on AWS marketplace:</p>
            <p class="center"><a target="_blank" href="https://aws.amazon.com/marketplace/pp/B07MLRWV22">SENTIENT Professional Edition Business</a></p>
            <br>
            <p>For detailed installation instructions please visit:</p>
            <p class="center"><a href="/docs/user-guide/install/pe/aws-marketplace/">Installing SENTIENT Professional Edition on AWS</a></p>
        </div>    
        <div id="enterprise-form" class="instructions" style="display: none;">
            <p>In order to proceed please visit the official product page on AWS marketplace:</p>
            <p class="center"><a target="_blank" href="https://aws.amazon.com/marketplace/pp/B07MBYZSFQ">SENTIENT Professional Edition Enterprise</a></p>
            <br>
            <p>For detailed installation instructions please visit:</p>
            <p class="center"><a href="/docs/user-guide/install/pe/aws-marketplace/">Installing SENTIENT Professional Edition on AWS</a></p>
        </div>
